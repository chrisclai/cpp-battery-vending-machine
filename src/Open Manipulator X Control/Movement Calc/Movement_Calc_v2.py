...
if __name__ == "__main__":
    ...
    #Test coordinate #3: second quadrant, larger x, equal z
    #angle1 = angle_Calc([315, 0, 205], 0)

    #Test coordinate #4: third quadrant, small x, equal z, larger y
    #angle1 = angle_Calc([-20, 275, 205], 0)
    #print(angle1)
    #Test coordinate #4: second quadrant, smaller x, smaller z, smllaer y
    angle1 = angle_Calc([245, 50, 195], 0)
    print(angle1)
