...
class nowServingClient:
    ...
    def Receive_Decrypt_Print(self, active_socket):
        ...
        while True:
            ...
            print("Received: Cell 1 Voltage ->", self.battery_id1[7], "V")
            print("Received: Cell 2 Voltage ->", self.battery_id1[8], "V")
            print("Received: Cell 3 Voltage ->", self.battery_id1[9], "V")
            print("Received: Cell 4 Voltage->", self.battery_id1[10], "V")
            ...
            print("Received: Cell 1 Voltage ->", self.battery_id2[7], "V")
            print("Received: Cell 2 Voltage ->", self.battery_id2[8], "V")
            print("Received: Cell 3 Voltage ->", self.battery_id2[9], "V")
            print("Received: Cell 4 Voltage->", self.battery_id2[10], "V")
            ...
            print("Received: Cell 1 Voltage ->", self.battery_id3[7], "V")
            print("Received: Cell 2 Voltage ->", self.battery_id3[8], "V")
            print("Received: Cell 3 Voltage ->", self.battery_id3[9], "V")
            print("Received: Cell 4 Voltage->", self.battery_id3[10], "V")
            ...
            print("Received: Cell 1 Voltage ->", self.battery_id4[7], "V")
            print("Received: Cell 2 Voltage ->", self.battery_id4[8], "V")
            print("Received: Cell 3 Voltage ->", self.battery_id4[9], "V")
            print("Received: Cell 4 Voltage->", self.battery_id4[10], "V")
            ...
            # creating a diction to implement a JSON dump into a file
            dictionary = {
                "Battery Data": [
                    {
                        ...
                        "Cell 1 Voltage": self.battery_id1[7],
                        "Cell 2 Voltage": self.battery_id1[8],
                        "Cell 3 Voltage": self.battery_id1[9],
                        "Cell 4 Voltage": self.battery_id1[10]
                    },
                    {
                        ...
                        "Cell 1 Voltage": self.battery_id2[7],
                        "Cell 2 Voltage": self.battery_id2[8],
                        "Cell 3 Voltage": self.battery_id2[9],
                        "Cell 4 Voltage": self.battery_id2[10]
                    },
                    {
                        ...
                        "Cell 1 Voltage": self.battery_id3[7],
                        "Cell 2 Voltage": self.battery_id3[8],
                        "Cell 3 Voltage": self.battery_id3[9],
                        "Cell 4 Voltage": self.battery_id3[10]
                    },
                    {
                        ...
                        "Cell 1 Voltage": self.battery_id4[7],
                        "Cell 2 Voltage": self.battery_id4[8],
                        "Cell 3 Voltage": self.battery_id4[9],
                        "Cell 4 Voltage": self.battery_id4[10]
                    },
                    {
                        "ID": self.battery_id5[0],
                        "Capacity": self.battery_id5[1],
                        "Energy": self.battery_id5[2],
                        "Charge Capacity": self.battery_id5[3],
                        "Temperature": self.battery_id5[4],
                        "BMS Health": self.battery_id5[5],
                        "Total Voltage": self.battery_id5[6],
                        "Cell 1 Voltage": self.battery_id5[7],
                        "Cell 2 Voltage": self.battery_id5[8],
                        "Cell 3 Voltage": self.battery_id5[9],
                        "Cell 4 Voltage": self.battery_id5[10]
                    }
                ]
            }
